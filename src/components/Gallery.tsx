...
export default function Gallery() {
  ...
  return (
    <section id="gallery" className="relative bg-[#0F0F0F] py-24 sm:py-32 border-t border-[#D4AF37]/10">
          ...
          <AnimatePresence>
            {filteredItems.map((item, index) => (
              <motion.div
                ...
                className="group relative cursor-pointer overflow-hidden rounded-2xl border border-[#D4AF37]/20 bg-[#1B1B1B]"
              >
                ...
                <div className="absolute inset-0 flex flex-col justify-between p-6">
                  <div className="flex justify-end">
                    <div className="flex h-10 w-10 items-center justify-center rounded-full border border-[#D4AF37]/40 bg-[#0F0F0F]/80 text-[#D4AF37] opacity-0 transition-all duration-300 group-hover:opacity-100 group-hover:scale-105">
                  ...
                  <div>
                    ...
                    <h3 className="mt-1 font-heading text-lg font-bold text-[#F7F7F7]">
                      {item.title}
                    </h3>
                    <p className="text-xs text-[#F7F7F7]/70">
                      {item.subtitle}
                    </p>
                  </div>
                </div>
      ...
      <AnimatePresence>
        {selectedImageIndex !== null && (
          ...
          >
            ...
            <div className="relative max-h-[85vh] max-w-4xl overflow-hidden rounded-2xl border border-[#D4AF37]/40 bg-[#0F0F0F]">
              ...
              <div className="border-t border-[#D4AF37]/20 bg-[#1B1B1B] p-4 text-center">
